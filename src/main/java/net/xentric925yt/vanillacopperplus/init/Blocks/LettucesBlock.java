...
public class LettucesBlock extends CropBlock {
    public static final MapCodec<LettucesBlock> CODEC = createCodec(LettucesBlock::new);
    ...
    public MapCodec<LettucesBlock> getCodec() {
        return CODEC;
    }

    public LettucesBlock(AbstractBlock.Settings settings) {
        super(settings);
    }
